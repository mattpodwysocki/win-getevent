  ...
  start () {
    this._id = setTimeout(() => {
      ...
      if (this.options.userName && this.options.password) {
        creds =  `$User = '${this.options.userName}'; $Pass = ConvertTo-SecureString -String '${this.options.password}' -AsPlainText -Force; $Credential = New-Object â€“TypeName 'System.Management.Automation.PSCredential' â€“ArgumentList $User, $Pass; `;
